...
const API_BASE = 'https://task-manager-3-3rzq.onrender.com/api/tasks';
const sortOptions = [
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-6 gap-3">
        <div className="min-w-0">
          <h1 className="text-xl md:text-3xl font-bold text-[#1e293b] flex items-center gap-2">
            <ListChecks className="text-[#3b82f6] w-5 h-5 md:w-6 md:h-6" />
            <span className="truncate">Pending Tasks</span>
          </h1>
          <p className="text-sm text-[#64748b] mt-1 ml-7">
            {sortedPendingTasks.length} task{sortedPendingTasks.length !== 1 && "s"} pending
          </p>
        </div>
